          ...
          <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-center space-y-12">
            ...
            <div className="space-y-16 pt-8">
              ...
              <div className="space-y-8">
                <h3 className="font-bold text-xl sm:text-2xl text-on-surface">Frontend</h3>
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
                  {[
                    ...
                    { name: 'Angular', icon: 'polyline' },
                  ].map((tech) => (
                    <div key={tech.name} className="flex flex-col items-center gap-2 transition-all hover:opacity-100 hover:scale-110 select-none w-20">
                      <span className="material-symbols-outlined text-4xl text-primary select-none">{tech.icon}</span>
              ...
              {/* Backend & Databases */}
              <div className="space-y-8">
                <h3 className="font-bold text-xl sm:text-2xl text-on-surface">Backend & Databases</h3>
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
                  {[
                    { name: 'Django', icon: 'dns' },
                    { name: 'Python', icon: 'terminal' },
                    { name: 'C#', icon: 'code_blocks' },
                    { name: 'C++', icon: 'memory' },
                    { name: 'Oracle', icon: 'database' },
                    { name: 'PostgreSQL', icon: 'storage' },
                    { name: 'Supabase', icon: 'cloud_sync' },
                  ].map((tech) => (
                    <div key={tech.name} className="flex flex-col items-center gap-2 transition-all hover:opacity-100 hover:scale-110 select-none w-20">
                      <span className="material-symbols-outlined text-4xl text-primary select-none">{tech.icon}</span>
                      <span className="text-xs sm:text-sm font-medium">{tech.name}</span>
              ...
              {/* Herramientas & Otros */}
              <div className="space-y-8">
                <h3 className="font-bold text-xl sm:text-2xl text-on-surface">Herramientas & Otros</h3>
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
                  {[
                    { name: 'Git', icon: 'account_tree' },
                    { name: 'Antigravity', icon: 'code' },
                    { name: 'MySQL', icon: 'dataset' },
                    { name: 'DBeaver', icon: 'table_view' },
                  ].map((tech) => (
                    <div key={tech.name} className="flex flex-col items-center gap-2 transition-all hover:opacity-100 hover:scale-110 select-none w-20">
                      <span className="material-symbols-outlined text-4xl text-primary select-none">{tech.icon}</span>
                      <span className="text-xs sm:text-sm font-medium">{tech.name}</span>
            ...
            <h3 className="font-bold text-2xl sm:text-3xl text-on-surface mt-20 mb-8 pt-8 border-t border-outline-variant/10">Actualmente Aprendiendo</h3>
